          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                Create survey questions & edit all field labels in real-time with live side-by-side preview.
              </p>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  {activeStepTab === 4 && (
                    <div className="space-y-4 bg-white p-4 rounded-2xl border border-gray-200">
                      <div>
                        <label className="block text-xs font-bold text-gray-700 mb-1">Modal Mode</label>
              ...
              {activeTab === 'survey' && (
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h4 className="text-xs font-extrabold text-amber-600 uppercase tracking-wider">
                      Real-Time Survey Builder & Checkboxes
                    </h4>
                  ...
                  {surveyQuestions.map((q, idx) => (
                    <div key={q.id || idx} className="p-4 rounded-2xl bg-white border border-gray-200 space-y-3">
                      ...
                      <div className="space-y-1.5 pt-1">
                        <label className="block text-[11px] font-bold text-gray-600">Options</label>
